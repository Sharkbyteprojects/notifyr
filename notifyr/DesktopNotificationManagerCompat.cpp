...
namespace DesktopNotificationManagerCompat
{
    ...
    HRESULT _UNRegisterComServer(GUID clsid)
    {
        // Turn the GUID into a string
        OLECHAR* clsidOlechar;
        StringFromCLSID(clsid, &clsidOlechar);
        ...
        std::wstring _2 = subKey + LR"(\LocalServer32)";
#ifdef _WIN64
#define k KEY_WOW64_64KEY
#else
#define k KEY_WOW64_32KEY
#endif
        // Register the EXE for the COM server
        ::RegDeleteKeyExW(HKEY_CURRENT_USER, _2.c_str(), k, NULL);
        return HRESULT_FROM_WIN32(::RegDeleteKeyExW(HKEY_CURRENT_USER, subKey.c_str(), k, NULL));
#undef k
    }
